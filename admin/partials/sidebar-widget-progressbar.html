    ...
    <ul class="nav nav-sidebar">
      ...
      <li class="nav-parent">
        ...
        <ul class="children collapse">
          ...
          <li><a href="../builder/email-builder/index.html"> Email</a></li>
      ...
      <li class="nav-parent">
        ...
        <ul class="children collapse">
          <li><a href="layouts-api.html" data-translate=""> API</a></li>
          <li><a href="layout-collapsed-sidebar.html" data-translate=""> Collapsed Sidebar</a></li>
          <li><a href="layout-topbar-menu.html" data-translate=""> Horizontal Mega Menu</a></li>
          <li><a href="layout-topbar-menu-dark.html" data-translate=""> Horizontal Mega Menu Dark</a></li>
      ...
      <li class="nav-parent">
        ...
        <ul class="children collapse">
          ...
          <li><a href="medias-manager.html"> <span class="pull-right badge badge-success">low</span> <span data-translate="medias manager">Medias Manager</span></a></li>
        </ul>
      </li>
      <li class="nav-parent">
      ...
      <li class="nav-parent">
        ...
        <ul class="children collapse">
          <li><a href="ecommerce-dashboad.html"> Dashboard</a></li>
          <li><a href="ecommerce-cart.html"> Shopping Cart</a></li>
          <li><a href="ecommerce-invoice.html"> Invoice</a></li>
          <li><a href="ecommerce-pricing-table.html"><span class="pull-right badge badge-success">5</span> Pricing Tables</a></li>
        </ul>
      </li>
      <li class="nav-parent">
        ...
        <ul class="children collapse">
          ...
          <li><a href="extra-intro.html"> Intro</a></li>
        </ul>
      </li>
    </ul>
    <!-- SIDEBAR WIDGET PROGRESS CHARTS -->
    <div class="sidebar-widgets">
      ...
      <div class="charts-sidebar progress-chart">
        ...
        <div class="sidebar-charts-inner">
          ...
          <div class="progress">
            <div class="progress-bar progress-bar-primary stat3" aria-valuetransitiongoal="93"></div>
          </div>
        </div>
      </div>
    </div>
